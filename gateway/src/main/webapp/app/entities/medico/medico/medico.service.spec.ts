...
import { Medico } from '@/shared/model/medico/medico.model';
...
describe('Service Tests', () => {
  describe('Medico Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Medico(123, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Medico', async () => {
        const patchObject = { nombre: 'BBBBBB', especialidad: 'BBBBBB', turno: 'BBBBBB', ...new Medico() };
